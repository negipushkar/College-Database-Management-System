  ...
  <body>
    ...
    <div class="Main">
      ...
      <div class="main2">
        ...
        <form class="" action="php/display.php" method="Post">
          <div class="lname">
...
<input type="tel" name="rollSearch" value=""placeholder="Enter Roll Number of Student" required minlength="6" maxlength="6" pattern="[0-9]+">
            ...
            <div id="noexists">
                <h1> Roll number <?php echo $_SESSION['rollValueSearch']; ?> doesn't exist </h1>
            </div>
          <div  class="submit" >
      ...
      <script>
      var show = <?php echo json_encode($_SESSION['exists']); ?>;
