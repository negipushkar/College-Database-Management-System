        ...
        if($conn){
            ...
            switch($val){
                case "Computer Science and Engineering":
                    $query = "SELECT * FROM student WHERE Department = '$val';";
  ...
  <head>
    ...
    <div class="titl">
      <h1>Student List</h1>
        ...
        <form method="post" action="StudentList.php" id="list">
        <div class="filter">
            <label><h1>Filter Department</h1></label>
            <select class="" name="DepFilter" id="list" onchange="this.form.submit()">
        ...
        <script>
            ...
            var op = <?php echo json_encode($_SESSION['selectedOp']); ?>;
            switch(op){
